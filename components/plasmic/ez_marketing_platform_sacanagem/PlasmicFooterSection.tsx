...
import Button3 from "../../Button3"; // plasmic-import: IJxJcHymAHEt/component
...
import sty from "./PlasmicFooterSection.module.css"; // plasmic-import: u6frPd1Kf3_M/css

import FacebookSvgIcon from "./icons/PlasmicIcon__FacebookSvg"; // plasmic-import: lNa9ob8V-43W/icon
import TwitterSvgIcon from "./icons/PlasmicIcon__TwitterSvg"; // plasmic-import: gWqx7bPo0Z_c/icon
import InstagramSvgIcon from "./icons/PlasmicIcon__InstagramSvg"; // plasmic-import: NJKfYv85f4GM/icon
import LinkedinSvgIcon from "./icons/PlasmicIcon__LinkedinSvg"; // plasmic-import: GAOB6YKR4Jg_/icon
...
function PlasmicFooterSection__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__gTtn4)}>
        <div className={classNames(projectcss.all, sty.freeBox___8XlhT)}>
          <PlasmicImg__
            ...
            loading={"lazy"}
            src={{
              src: "/plasmic/ez_marketing_platform_sacanagem/images/logoSvg2.svg",
              fullWidth: 297,
              fullHeight: 210,
          ...
          <div className={classNames(projectcss.all, sty.freeBox__ok4EN)}>
            <FacebookSvgIcon
              className={classNames(projectcss.all, sty.svg___378H2)}
              role={"img"}
            />

            <TwitterSvgIcon
              className={classNames(projectcss.all, sty.svg___3ZikG)}
              role={"img"}
            />

            <InstagramSvgIcon
              className={classNames(projectcss.all, sty.svg__h4WU)}
              role={"img"}
            />

            <LinkedinSvgIcon
              className={classNames(projectcss.all, sty.svg__zh2Zs)}
              role={"img"}
            />
          </div>
        </div>
        <div className={classNames(projectcss.all, sty.freeBox___3Rquk)}>
          <h4
      ...
      <div className={classNames(projectcss.all, sty.freeBox__gp0An)}>
        <div
          className={classNames(
            projectcss.all,
            projectcss.__wab_text,
