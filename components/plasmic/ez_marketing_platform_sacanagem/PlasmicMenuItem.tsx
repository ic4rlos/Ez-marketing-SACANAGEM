...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: P8rrkIDuSXIc/css
...
function PlasmicMenuItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__jJWh)}>
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__rXmjo)}>
            <div
              className={classNames(
                projectcss.all,
