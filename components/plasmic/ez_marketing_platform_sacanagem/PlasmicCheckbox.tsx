...
import sty from "./PlasmicCheckbox.module.css"; // plasmic-import: rFFBNHlDUYHp/css

import CheckIcon from "./icons/PlasmicIcon__Check"; // plasmic-import: Aqn98hvofraL/icon
import MinusIcon from "./icons/PlasmicIcon__Minus"; // plasmic-import: IsXNFjywBZL8/icon
...
function PlasmicCheckbox__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      >
        <CheckIcon
          className={classNames(projectcss.all, sty.svg__x7EsM)}
          role={"img"}
        />

        <MinusIcon
          className={classNames(projectcss.all, sty.svg__hz55N)}
          role={"img"}
        />
      </div>
      {renderPlasmicSlot({
