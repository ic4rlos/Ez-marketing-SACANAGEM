...
import sty from "./PlasmicLCCreateAccount.module.css"; // plasmic-import: zVgyaOjjhlZQ/css
              ...
              return (
                ...
                >
                  <FormItemWrapper
                    className={classNames(
                      "__wab_instance",
                      sty.formField__dtkOh
                    )}
                    label={
                      <UserSvgIcon
                        className={classNames(projectcss.all, sty.svg__eaucH)}
                        role={"img"}
                      />
                    }
                    name={"email"}
                  ...
                  <FormItemWrapper
                    className={classNames(
                      "__wab_instance",
                      sty.formField__f0J8H
                    )}
                    label={
                      <LockSvgIcon
                        className={classNames(projectcss.all, sty.svg___8FxFt)}
                        role={"img"}
                      />
                    }
                    name={"password"}
                  ...
                  <FormItemWrapper
                    className={classNames(
                      "__wab_instance",
                      sty.formField__nQnhd
                    )}
                    label={
                      <LockSvgIcon
                        className={classNames(projectcss.all, sty.svg__aJ2Oj)}
                        role={"img"}
                      />
                    }
