...
import sty from "./PlasmicPlusButton.module.css"; // plasmic-import: dEfTtbU6O5yi/css
...
export type PlasmicPlusButton__VariantMembers = {
...
export type PlasmicPlusButton__VariantsArgs = {
...
type VariantPropType = keyof PlasmicPlusButton__VariantsArgs;
export const PlasmicPlusButton__VariantProps = new Array<VariantPropType>(
  "showStartIcon",
  "showEndIcon",
  "isDisabled",
  "shape",
...
export type PlasmicPlusButton__ArgsType = {
  link?: string;
  submitsForm?: boolean;
  target?: boolean;
...
type ArgPropType = keyof PlasmicPlusButton__ArgsType;
export const PlasmicPlusButton__ArgProps = new Array<ArgPropType>(
  "link",
  "submitsForm",
  "target",
  "startIcon",
...
export type PlasmicPlusButton__OverridesType = {
  root?: Flex__<"button">;
...
export interface DefaultPlusButtonProps extends pp.BaseButtonProps {
  submitsForm?: boolean;
  target?: boolean;
  shape?: SingleChoiceArg<"rounded" | "round" | "sharp">;
  size?: SingleChoiceArg<"compact" | "minimal">;
...
function PlasmicPlusButton__RenderFunc(props: {
  variants: PlasmicPlusButton__VariantsArgs;
  args: PlasmicPlusButton__ArgsType;
  overrides: PlasmicPlusButton__OverridesType;
  forNode?: string;
}) {
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CheckSvgIcon
                className={classNames(projectcss.all, sty.svg__hxYqM)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <Icon38Icon
                className={classNames(projectcss.all, sty.svg__b8KQw)}
                role={"img"}
              />
            ),
...
function useBehavior<P extends pp.PlumeButtonProps>(
  ...
  const b = pp.useButton<P, typeof PlasmicPlusButton>(
    PlasmicPlusButton,
    props,
    {
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicPlusButton__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicPlusButton__VariantsArgs, ReservedPropsType> &
    // Specify args directly as props
    Omit<PlasmicPlusButton__ArgsType, ReservedPropsType> &
