...
import Logo2 from "../../Logo2"; // plasmic-import: 9bCtcVAcM2-Q/component
import Button5 from "../../Button5"; // plasmic-import: fE6qceeBdd3i/component
...
import sty from "./PlasmicNavbar2.module.css"; // plasmic-import: eleeTDsx-h9m/css
...
function PlasmicNavbar2__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__pBq6L)}>
        <Logo2
        ...
        <div className={classNames(projectcss.all, sty.freeBox__obBpP)}>
          <PlasmicLink__
            className={classNames(
              projectcss.all,
              projectcss.a,
        ...
        <div className={classNames(projectcss.all, sty.freeBox__aXqDd)}>
          <PlasmicLink__
            className={classNames(
              projectcss.all,
              projectcss.a,
