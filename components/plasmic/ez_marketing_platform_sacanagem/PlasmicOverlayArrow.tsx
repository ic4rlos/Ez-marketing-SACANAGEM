...
import sty from "./PlasmicOverlayArrow.module.css"; // plasmic-import: gyuMu576tdNx/css

import TriangleFilledIcon from "./icons/PlasmicIcon__TriangleFilled"; // plasmic-import: Ryc4EFA6xsfL/icon
