...
import sty from "./PlasmicDialog.module.css"; // plasmic-import: cVxNOpd4pKJF/css
...
function PlasmicDialog__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      >
        <div className={classNames(projectcss.all, sty.freeBox__lHbhi)}>
          <DialogTitle
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <div className={classNames(projectcss.all, sty.freeBox__qg0Ms)}>
                <div
                  className={classNames(
                    projectcss.all,
        ...
        <div className={classNames(projectcss.all, sty.freeBox__sEn2)}>
          <DialogClose
