...
import sty from "./PlasmicSignInWithGoogle.module.css"; // plasmic-import: Ka3vuWh8xciy/css
...
export type PlasmicSignInWithGoogle__VariantMembers = {
...
export type PlasmicSignInWithGoogle__VariantsArgs = {
...
type VariantPropType = keyof PlasmicSignInWithGoogle__VariantsArgs;
export const PlasmicSignInWithGoogle__VariantProps = new Array<VariantPropType>(
  "showStartIcon",
  "showEndIcon",
  "isDisabled",
  "shape",
...
export type PlasmicSignInWithGoogle__ArgsType = {
...
type ArgPropType = keyof PlasmicSignInWithGoogle__ArgsType;
export const PlasmicSignInWithGoogle__ArgProps = new Array<ArgPropType>(
  "children",
  "startIcon",
  "endIcon",
  "link",
...
export type PlasmicSignInWithGoogle__OverridesType = {
  root?: Flex__<"button">;
...
export interface DefaultSignInWithGoogleProps extends pp.BaseButtonProps {
  submitsForm?: boolean;
  target?: boolean;
  shape?: SingleChoiceArg<"rounded" | "round" | "sharp">;
  size?: SingleChoiceArg<"compact" | "minimal">;
...
function PlasmicSignInWithGoogle__RenderFunc(props: {
  variants: PlasmicSignInWithGoogle__VariantsArgs;
  args: PlasmicSignInWithGoogle__ArgsType;
  overrides: PlasmicSignInWithGoogle__OverridesType;
  forNode?: string;
}) {
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CheckSvgIcon
                className={classNames(projectcss.all, sty.svg__aGRkF)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <Icon38Icon
                className={classNames(projectcss.all, sty.svg__dw1Lf)}
                role={"img"}
              />
            ),
...
function useBehavior<P extends pp.PlumeButtonProps>(
  ...
  const b = pp.useButton<P, typeof PlasmicSignInWithGoogle>(
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicSignInWithGoogle__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicSignInWithGoogle__VariantsArgs, ReservedPropsType> &
    // Specify args directly as props
    Omit<PlasmicSignInWithGoogle__ArgsType, ReservedPropsType> &
