...
import sty from "./PlasmicHomepage2.module.css"; // plasmic-import: tWsc7cLHj7QX/css
    ...
    <React.Fragment>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          >
            <div className={classNames(projectcss.all, sty.freeBox__baOt5)}>
              <div className={classNames(projectcss.all, sty.freeBox___9KclF)}>
                <NavigationBar
                  ...
                  brand={
                    ...
                    >
                      <PlasmicImg__
                        alt={""}
                        className={classNames(sty.img__gu9Dv)}
                        displayHeight={"30px"}
                  ...
                  closeButton={
                    <PlasmicImg__
                      alt={""}
                      className={classNames(sty.img__iEioY)}
                      displayHeight={"auto"}
                      displayMaxHeight={"none"}
                      displayMaxWidth={"none"}
                      displayMinHeight={"0"}
                  ...
                  openButton={
                    <PlasmicImg__
                      alt={""}
                      className={classNames(sty.img__qbPnD)}
                      displayHeight={"auto"}
                      displayMaxHeight={"none"}
                      displayMaxWidth={"none"}
                      displayMinHeight={"0"}
                ...
                <AntdDropdown
                  ...
                  menuClassName={classNames({
                    [sty["pcls_sic4bCfrNFg-"]]: true
                  })}
                  menuItemClassName={classNames({
                    [sty["pcls_OMriFkjSqvJy"]]: true
                  })}
                  menuItems={() => (
                    <React.Fragment>
                      <AntdMenuItem
                ...
                >
                  ...
                  >
                    <PlasmicImg__
                      alt={""}
                      className={classNames(sty.img___7AqIj)}
                      displayHeight={"30px"}
                      displayMaxHeight={"none"}
                      displayMaxWidth={"100%"}
                      displayMinHeight={"0"}
