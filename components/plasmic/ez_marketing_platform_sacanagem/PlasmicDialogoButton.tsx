...
import sty from "./PlasmicDialogoButton.module.css"; // plasmic-import: hR0UsvgBGeTr/css
...
export type PlasmicDialogoButton__VariantMembers = {
...
export type PlasmicDialogoButton__VariantsArgs = {
...
type VariantPropType = keyof PlasmicDialogoButton__VariantsArgs;
export const PlasmicDialogoButton__VariantProps = new Array<VariantPropType>(
  "showStartIcon",
  "showEndIcon",
  "isDisabled",
  "shape",
...
export type PlasmicDialogoButton__ArgsType = {
...
type ArgPropType = keyof PlasmicDialogoButton__ArgsType;
export const PlasmicDialogoButton__ArgProps = new Array<ArgPropType>(
  "children",
  "startIcon",
  "endIcon",
  "link",
...
export type PlasmicDialogoButton__OverridesType = {
  root?: Flex__<"button">;
...
export interface DefaultDialogoButtonProps extends pp.BaseButtonProps {
  submitsForm?: boolean;
  target?: boolean;
  shape?: SingleChoiceArg<"rounded" | "round" | "sharp">;
  size?: SingleChoiceArg<"compact" | "minimal">;
...
function PlasmicDialogoButton__RenderFunc(props: {
  variants: PlasmicDialogoButton__VariantsArgs;
  args: PlasmicDialogoButton__ArgsType;
  overrides: PlasmicDialogoButton__OverridesType;
  forNode?: string;
}) {
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CheckSvgIcon
                className={classNames(projectcss.all, sty.svg__b4Utk)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <Icon38Icon
                className={classNames(projectcss.all, sty.svg__eeIfE)}
                role={"img"}
              />
            ),
...
function useBehavior<P extends pp.PlumeButtonProps>(
  ...
  const b = pp.useButton<P, typeof PlasmicDialogoButton>(
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicDialogoButton__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicDialogoButton__VariantsArgs, ReservedPropsType> &
    // Specify args directly as props
    Omit<PlasmicDialogoButton__ArgsType, ReservedPropsType> &
