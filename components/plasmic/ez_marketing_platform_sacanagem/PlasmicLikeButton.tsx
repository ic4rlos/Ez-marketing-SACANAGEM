...
import sty from "./PlasmicLikeButton.module.css"; // plasmic-import: IkOxa2jRdCsR/css
...
export type PlasmicLikeButton__VariantMembers = {
...
export type PlasmicLikeButton__VariantsArgs = {
...
type VariantPropType = keyof PlasmicLikeButton__VariantsArgs;
export const PlasmicLikeButton__VariantProps = new Array<VariantPropType>(
  "showStartIcon",
  "showEndIcon",
  "isDisabled",
  "shape",
...
export type PlasmicLikeButton__ArgsType = {
...
type ArgPropType = keyof PlasmicLikeButton__ArgsType;
export const PlasmicLikeButton__ArgProps = new Array<ArgPropType>(
  "children",
  "startIcon",
  "endIcon",
  "link",
...
export type PlasmicLikeButton__OverridesType = {
  root?: Flex__<"button">;
...
export interface DefaultLikeButtonProps extends pp.BaseButtonProps {
  submitsForm?: boolean;
  target?: boolean;
  shape?: SingleChoiceArg<"rounded" | "round" | "sharp">;
  size?: SingleChoiceArg<"compact" | "minimal">;
...
function PlasmicLikeButton__RenderFunc(props: {
  variants: PlasmicLikeButton__VariantsArgs;
  args: PlasmicLikeButton__ArgsType;
  overrides: PlasmicLikeButton__OverridesType;
  forNode?: string;
}) {
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CheckSvgIcon
                className={classNames(projectcss.all, sty.svg__bctH5)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <Icon38Icon
                className={classNames(projectcss.all, sty.svg__dmfYj)}
                role={"img"}
              />
            ),
...
function useBehavior<P extends pp.PlumeButtonProps>(
  ...
  const b = pp.useButton<P, typeof PlasmicLikeButton>(
    PlasmicLikeButton,
    props,
    {
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicLikeButton__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicLikeButton__VariantsArgs, ReservedPropsType> &
    // Specify args directly as props
    Omit<PlasmicLikeButton__ArgsType, ReservedPropsType> &
