...
import sty from "./PlasmicButton6.module.css"; // plasmic-import: DP0kTpoAT5DB/css
...
function PlasmicButton6__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__dgKYf, {
          [sty.freeBoxcolor_neutral__dgKYfBMeKw]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxcolor_success_type_bordered__dgKYfM2YhdSfko4]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered"),
          [sty.freeBoxcolor_white__dgKYfa2Myh]: hasVariant(
            $state,
            "color",
            "white"
          ),
          [sty.freeBoxroundedFull__dgKYfIv2Bc]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__dgKYf1D02]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__dgKYfc0E4Q]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__dgKYfghMjj]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__dgKYfvEnNe]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__dgKYfsfko4]: hasVariant(
            $state,
            "type",
            "bordered"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__t5CJb, {
            [sty.freeBoxcolor_neutral__t5CJbbMeKw]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxcolor_neutral_type_soft__t5CJbbMeKwVwJbp]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft"),
            [sty.freeBoxiconStart__t5CJBv2Nv2]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__t5CJb1D02]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__t5CJBghMjj]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__t5CJBvEnNe]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__t5CJBsfko4]: hasVariant(
              $state,
              "type",
              "bordered"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__bIcUt)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox___5G0U, {
            [sty.freeBoxiconEnd___5G0UgtpQ]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge___5G0U1D02]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large___5G0UghMjj]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small___5G0UvEnNe]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDownIcon
                className={classNames(projectcss.all, sty.svg__vGtlt)}
                role={"img"}
              />
            ),
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicButton6__VariantsArgs, ReservedPropsType> &
