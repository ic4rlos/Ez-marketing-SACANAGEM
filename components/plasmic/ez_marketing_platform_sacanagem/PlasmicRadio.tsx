...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: Ycw8aTg4CH4P/css
...
function PlasmicRadio__RenderFunc(props: {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames(projectcss.all, sty.freeBox__sOzj6)}>
        <div className={classNames(projectcss.all, sty.freeBox__w7Sio)} />
      </div>
      {renderPlasmicSlot({
