...
import sty from "./PlasmicLANewPassword.module.css"; // plasmic-import: 2_akEx5CK2Wa/css
              ...
              return (
                ...
                >
                  <FormItemWrapper
                    className={classNames(
                      "__wab_instance",
                      sty.formField__v8Kem
                    )}
                    label={
                      <LockSvgIcon
                        className={classNames(projectcss.all, sty.svg__lp1P)}
                        role={"img"}
                      />
                    }
                    name={"password"}
                  ...
                  <FormItemWrapper
                    className={classNames(
                      "__wab_instance",
                      sty.formField__rg8P0
                    )}
                    label={
                      <LockSvgIcon
                        className={classNames(projectcss.all, sty.svg__sEq)}
                        role={"img"}
                      />
                    }
