...
import Radio from "../../Radio"; // plasmic-import: Ycw8aTg4CH4P/component
...
import sty from "./PlasmicRadioGroup.module.css"; // plasmic-import: IlcCQwdNGfH0/css
...
function PlasmicRadioGroup__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox__vBdhp)}>
            <Radio
              className={classNames("__wab_instance", sty.radio__l3Gi8)}
              label={"Option 1"}
              value={"option1"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__l1Fg)}
              label={"Option 2"}
              value={"option2"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__ybgKe)}
              label={"Option 3"}
              value={"option3"}
            />
          </div>
