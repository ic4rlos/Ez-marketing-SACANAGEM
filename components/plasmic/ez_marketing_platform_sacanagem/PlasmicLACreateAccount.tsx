...
import Checkbox from "../../Checkbox"; // plasmic-import: rFFBNHlDUYHp/component
import SignInWithGoogle from "../../SignInWithGoogle"; // plasmic-import: Ka3vuWh8xciy/component
...
import sty from "./PlasmicLACreateAccount.module.css"; // plasmic-import: dOCEBZKmUOqj/css
              ...
              return (
                ...
                >
                  <FormItemWrapper
                    className={classNames(
                      "__wab_instance",
                      sty.formField__xV7D4
                    )}
                    label={
                      <UserSvgIcon
                        className={classNames(projectcss.all, sty.svg___41Xjw)}
                        role={"img"}
                      />
                    }
                    name={"email"}
                  ...
                  <FormItemWrapper
                    className={classNames(
                      "__wab_instance",
                      sty.formField__ncqX0
                    )}
                    label={
                      <LockSvgIcon
                        className={classNames(projectcss.all, sty.svg__wLqLg)}
                        role={"img"}
                      />
                    }
                    name={"password"}
                  ...
                  <FormItemWrapper
                    className={classNames(
                      "__wab_instance",
                      sty.formField__pjH7T
                    )}
                    label={
                      <LockSvgIcon
                        className={classNames(projectcss.all, sty.svg__aIEpE)}
                        role={"img"}
                      />
                    }
                  ...
                  <div
                    className={classNames(projectcss.all, sty.freeBox__nehW9)}
                  >
                    <Checkbox
...
export const PlasmicLACreateAccount = Object.assign(
  ...
  makeNodeComponent("root"),
  {
    ...
    pageMetadata: generateDynamicMetadata(wrapQueriesWithLoadingProxy({}), {
      pageRoute: "/a-create-account",
      pagePath: "/a-create-account",
      params: {},
      query: {}
    })
  }
