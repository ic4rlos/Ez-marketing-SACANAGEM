...
import sty from "./PlasmicButton4.module.css"; // plasmic-import: QBrQpOnv-BA6/css
...
function PlasmicButton4__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__m3JyL, {
          [sty.freeBoxcolor_neutral__m3JyLBffdV]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxcolor_success_type_bordered__m3JyLi8VnSLS3P]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered"),
          [sty.freeBoxcolor_white__m3JyLnSrvs]: hasVariant(
            $state,
            "color",
            "white"
          ),
          [sty.freeBoxroundedFull__m3JyLyuz17]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__m3JyLx6HF]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__m3JyLoKnC]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__m3JyLfBhTm]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__m3JyLTpRpO]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__m3JyLlS3P]: hasVariant(
            $state,
            "type",
            "bordered"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__hCaNu, {
            [sty.freeBoxcolor_neutral__hCaNuBffdV]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxcolor_neutral_type_soft__hCaNuBffdVHiSz6]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft"),
            [sty.freeBoxiconStart__hCaNuOkvN]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__hCaNuX6HF]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__hCaNufBhTm]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__hCaNuTpRpO]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__hCaNulS3P]: hasVariant(
              $state,
              "type",
              "bordered"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__n7Cx8)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__jNj7G, {
            [sty.freeBoxiconEnd__jNj7GPuv3R]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__jNj7GX6HF]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__jNj7GfBhTm]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__jNj7GTpRpO]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDownIcon
                className={classNames(projectcss.all, sty.svg__fngvj)}
                role={"img"}
              />
            ),
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicButton4__VariantsArgs, ReservedPropsType> &
