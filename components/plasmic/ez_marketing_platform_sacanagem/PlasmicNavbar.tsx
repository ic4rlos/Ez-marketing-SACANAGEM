...
import Logo from "../../Logo"; // plasmic-import: hSxFZvz06546/component
...
import sty from "./PlasmicNavbar.module.css"; // plasmic-import: MVqbq8_WQ656/css
...
function PlasmicNavbar__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__iPjQ)}>
        <Logo
        ...
        <div className={classNames(projectcss.all, sty.freeBox__yPxoC)}>
          <PlasmicLink__
            className={classNames(
              projectcss.all,
              projectcss.a,
        ...
        <div className={classNames(projectcss.all, sty.freeBox__yzMv2)}>
          <PlasmicLink__
            className={classNames(
              projectcss.all,
              projectcss.a,
