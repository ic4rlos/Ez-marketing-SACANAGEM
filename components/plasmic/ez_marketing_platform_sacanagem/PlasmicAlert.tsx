...
import sty from "./PlasmicAlert.module.css"; // plasmic-import: LffJYeTVDfY8/css
...
function PlasmicAlert__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__u2Qzw, {
          [sty.freeBoxnoBody__u2QzwDjmIt]: hasVariant(
            $state,
            "noBody",
            "noBody"
          ),
          [sty.freeBoxnoHeader__u2QzwryzGl]: hasVariant(
            $state,
            "noHeader",
            "noHeader"
          ),
          [sty.freeBoxnoIcon__u2QzwQRctS]: hasVariant(
            $state,
            "noIcon",
            "noIcon"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__mG2Q1, {
            [sty.freeBoxnoIcon__mG2Q1QRctS]: hasVariant(
              $state,
              "noIcon",
              "noIcon"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <Icon12Icon
                className={classNames(projectcss.all, sty.svg__iVPhq)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox___4UYoD, {
            [sty.freeBoxnoHeader___4UYoDryzGl]: hasVariant(
              $state,
              "noHeader",
              "noHeader"
            ),
            [sty.freeBoxnoIcon___4UYoDqRctS]: hasVariant(
              $state,
              "noIcon",
              "noIcon"
            )
        ...
        >
          ...
          <div
            className={classNames(projectcss.all, sty.freeBox__yv5Wf, {
              [sty.freeBoxnoBody__yv5WfDjmIt]: hasVariant(
                $state,
                "noBody",
                "noBody"
              ),
              [sty.freeBoxnoHeader__yv5WfryzGl]: hasVariant(
                $state,
                "noHeader",
                "noHeader"
              )
