...
import OverlayArrow from "../../OverlayArrow"; // plasmic-import: gyuMu576tdNx/component
...
import sty from "./PlasmicPopover.module.css"; // plasmic-import: WpL-KtGi-6ZK/css
  ...
  return (
    <BaseDialogTrigger
      ...
      dialog={
        ...
        >
          ...
          >
            {renderPlasmicSlot({
              defaultContents: (
                <div className={classNames(projectcss.all, sty.freeBox__k8NfB)}>
                  <div
                    className={classNames(
                      projectcss.all,
      ...
      trigger={renderPlasmicSlot({
        defaultContents: (
          <Button2
            className={classNames("__wab_instance", sty.button2__qql8A)}
            label={"Open Popover"}
          />
        ),
