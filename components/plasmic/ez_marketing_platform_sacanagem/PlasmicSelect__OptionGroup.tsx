...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: ePmUwIt6mdEt/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: vemQBrKXwwxW/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__oOSwQ)}
              >
                <div
                  className={classNames(
                    projectcss.all,
              ...
              <Select__Option
                className={classNames("__wab_instance", sty.option__zAhiz)}
              >
                <div
                  className={classNames(
                    projectcss.all,
