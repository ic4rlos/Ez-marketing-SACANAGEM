...
import sty from "./PlasmicLinkPreview.module.css"; // plasmic-import: JUoZhzG6avZV/css
...
function PlasmicLinkPreview__RenderFunc(props: {
  ...
  return (
    ...
    >
      <DataCtxReader__>
        {$ctx => (
          <div className={classNames(projectcss.all, sty.freeBox__yhkPf)}>
            <PlasmicImg__
            ...
            <div className={classNames(projectcss.all, sty.freeBox___2GfUj)}>
              <div className={classNames(projectcss.all, sty.freeBox__ags2J)}>
                <h5
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicLinkPreview__VariantsArgs, ReservedPropsType> &
