...
import sty from "./PlasmicSlider.module.css"; // plasmic-import: 1ICtaMB_X11V/css
  ...
  return (
    ...
    >
      {$props.showLabel || $props.showOutputText ? (
        <div className={classNames(projectcss.all, sty.freeBox__t4Upe)}>
          {$props.showLabel ? (
            <Label2
      ...
      <div className={classNames(projectcss.all, sty.freeBox__zVVh)}>
        <div
