...
import sty from "./PlasmicCheckboxGroup.module.css"; // plasmic-import: dVkixCirBUvF/css
...
function PlasmicCheckboxGroup__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox__z9Vc3)}>
            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__m9MFt)}
              label={"Option 1"}
              value={"option1"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__etORw)}
              label={"Option 2"}
              value={"option2"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__pcKdz)}
              label={"Option 3"}
              value={"option3"}
            />
          </div>
