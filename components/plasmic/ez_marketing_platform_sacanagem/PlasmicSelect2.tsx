...
import MenuPopover from "../../MenuPopover"; // plasmic-import: LqtMDYcHWN9e/component
import MenuItem from "../../MenuItem"; // plasmic-import: P8rrkIDuSXIc/component
import MenuSection from "../../MenuSection"; // plasmic-import: j75faqJp9DbO/component
...
import sty from "./PlasmicSelect2.module.css"; // plasmic-import: fQPtvAhk0Dy_/css
        ...
        menuItems={renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              ...
              <MenuSection
                className={classNames("__wab_instance", sty.menuSection__wtGqK)}
                header={
                  <div
                    className={classNames(
                      projectcss.all,
