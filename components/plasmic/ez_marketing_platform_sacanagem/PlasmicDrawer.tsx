...
import sty from "./PlasmicDrawer.module.css"; // plasmic-import: 9Ke8arn03BB3/css
    ...
    >
      ...
      >
        ...
        >
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <div className={classNames(projectcss.all, sty.freeBox__qcMo2)}>
                <div
                  className={classNames(
                    projectcss.all,
                    projectcss.__wab_text,
