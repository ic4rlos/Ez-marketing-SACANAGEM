...
import Label from "../../Label"; // plasmic-import: OxZlFil8tmu-/component
import TextInput from "../../TextInput"; // plasmic-import: gYnePiOWPQhY/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: r-qB_u2BtCHR/component
import Description from "../../Description"; // plasmic-import: B9sugsRT3xmK/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: OPQkyGb1rD5Z/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__o3IXs, {
          [sty.freeBoxiconEnd__o3IXSli9Pv]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__o3IXSae7Qu]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__o3IXsabsJd]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__kebY9, {
            [sty.freeBoxiconStart__kebY9Ae7Qu]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__kebY9AbsJd]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__clU3T)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__kwa2J, {
            [sty.freeBoxiconEnd__kwa2Jli9Pv]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__kwa2Jae7Qu]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__xzEp0)}
                role={"img"}
              />
            ),
