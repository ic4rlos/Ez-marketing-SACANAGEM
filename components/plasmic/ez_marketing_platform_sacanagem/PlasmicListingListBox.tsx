...
import sty from "./PlasmicListingListBox.module.css"; // plasmic-import: TtM6MATgCvVt/css
...
function PlasmicListingListBox__RenderFunc(props: {
  ...
  return (
    <PlasmicLink__
      ...
      platform={"nextjs"}
    >
      <div className={classNames(projectcss.all, sty.freeBox__pScc)}>
        {renderPlasmicSlot({
          defaultContents: (
            <PlasmicImg__
              alt={""}
              className={classNames(sty.img__pfq46)}
              displayHeight={"250px"}
              ...
              loading={"lazy"}
              src={{
                src: "/plasmic/ez_marketing_platform_sacanagem/images/house13533891280Jpg.jpg",
                fullWidth: 1280,
                fullHeight: 853,
      ...
      <div className={classNames(projectcss.all, sty.freeBox__s57XS)}>
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <div
              ...
              <div className={classNames(projectcss.all, sty.freeBox__v07B)}>
                <div className={classNames(projectcss.all, sty.freeBox__qbTd7)}>
                  <_14655891761535698998SvgIcon
                    className={classNames(projectcss.all, sty.svg__xhLJw)}
                    role={"img"}
                  />
                </div>
                <div className={classNames(projectcss.all, sty.freeBox__pN75H)}>
                  <div
                    className={classNames(
                      projectcss.all,
                      projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__j8Abd)}>
                <div
                  className={classNames(
                    projectcss.all,
                    projectcss.__wab_text,
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicListingListBox__VariantsArgs, ReservedPropsType> &
    // Specify args directly as props
    Omit<PlasmicListingListBox__ArgsType, ReservedPropsType> &
