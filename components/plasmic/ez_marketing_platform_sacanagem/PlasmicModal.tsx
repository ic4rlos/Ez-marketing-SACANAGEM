...
import sty from "./PlasmicModal.module.css"; // plasmic-import: 2mIwXeE-_Psc/css
    ...
    <BaseDialogTrigger
      ...
      dialog={
        <BaseModal
          ...
          modalOverlayClass={classNames({ [sty["pcls_SLnCVt0iisRr"]]: true })}
          ...
          >
            ...
            >
              {renderPlasmicSlot({
                defaultContents: (
                  <div
                    className={classNames(projectcss.all, sty.freeBox___0MGCb)}
                  >
                    <div
                      className={classNames(
                        projectcss.all,
            ...
            {$props.showFooter ? (
              ...
              >
                {renderPlasmicSlot({
                  defaultContents: (
                    <div
                      className={classNames(projectcss.all, sty.freeBox__eBpsG)}
                    >
                      <Button2
                        color={"muted"}
                        label={
