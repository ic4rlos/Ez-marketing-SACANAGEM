...
import sty from "./PlasmicCLandingPageContact.module.css"; // plasmic-import: NnfwBK-56ev7/css

import UserSvgIcon from "./icons/PlasmicIcon__UserSvg"; // plasmic-import: vF6c8HVR1OWZ/icon
import BriefcaseSvgIcon from "./icons/PlasmicIcon__BriefcaseSvg"; // plasmic-import: 7n3tjuSJ2a8Q/icon
import _4654364831553230929SvgIcon from "./icons/PlasmicIcon___4654364831553230929Svg"; // plasmic-import: Ru-n-6yUbTWS/icon
    ...
    <React.Fragment>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          >
            <div className={classNames(projectcss.all, sty.column___2REcG)}>
              <PlasmicImg__
                ...
                loading={"lazy"}
                src={{
                  src: "/plasmic/ez_marketing_platform_sacanagem/images/business2879499640Jpg.jpg",
                  fullWidth: 640,
                  fullHeight: 423,
            ...
            <div className={classNames(projectcss.all, sty.column__rmLwz)}>
              <h2
                ...
                return (
                  ...
                  >
                    <FormItemWrapper
                      ...
                      label={
                        <UserSvgIcon
                          className={classNames(projectcss.all, sty.svg__fPuTy)}
                          role={"img"}
                        />
                      }
                      name={"Name"}
                    ...
                    <FormItemWrapper
                      className={classNames(
                        "__wab_instance",
                        sty.formField__g6Dyf
                      )}
                      initialValue={undefined}
                      label={
                        <BriefcaseSvgIcon
                          className={classNames(projectcss.all, sty.svg__pbXfT)}
                          role={"img"}
                        />
                      }
                      name={"Company"}
                    ...
                    <FormItemWrapper
                      className={classNames(
                        "__wab_instance",
                        sty.formField__lvcqp
                      )}
                      initialValue={undefined}
                      label={
                        <_4654364831553230929SvgIcon
                          className={classNames(projectcss.all, sty.svg__owjv3)}
                          role={"img"}
                        />
                      }
                      name={"email"}
                    ...
                    <FormItemWrapper
                      className={classNames(
                        "__wab_instance",
                        sty.formField__hV271
                      )}
                      initialValue={undefined}
                      label={
                        <GlobeSvgIcon
                          className={classNames(projectcss.all, sty.svg__bsLfp)}
                          role={"img"}
                        />
                      }
                      name={"Website"}
                    ...
                    <FormItemWrapper
                      className={classNames(
                        "__wab_instance",
                        sty.formField__z4XLd
                      )}
                      initialValue={undefined}
                      label={
                        <SearchSvgIcon
                          className={classNames(projectcss.all, sty.svg__nyLy2)}
                          role={"img"}
                        />
                      }
...
export const PlasmicCLandingPageContact = Object.assign(
  ...
  makeNodeComponent("root"),
  {
    ...
    pageMetadata: generateDynamicMetadata(wrapQueriesWithLoadingProxy({}), {
      pageRoute: "/c-landing-page-contact",
