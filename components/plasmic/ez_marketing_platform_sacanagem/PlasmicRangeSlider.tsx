...
import SliderThumb from "../../SliderThumb"; // plasmic-import: kalKES3LXGHf/component
...
import sty from "./PlasmicRangeSlider.module.css"; // plasmic-import: Tvh6HWS6srNS/css
...
function PlasmicRangeSlider__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox___7BiPi)}>
        {$props.showLabel ? (
          <Label2
      ...
      <div className={classNames(projectcss.all, sty.freeBox__dnFiB)}>
        <div
